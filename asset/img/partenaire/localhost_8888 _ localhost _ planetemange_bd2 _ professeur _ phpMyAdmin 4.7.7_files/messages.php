...
PMA_messages['strLeastColumnError'] = "Il faut ajouter au moins une colonne.";
...
PMA_messages['dropImportMessageAborted'] = "Abandonné(s)";
...
PMA_messages['phpErrorsFound'] = "<div class=\"error\">Des erreurs ont été détectées sur le serveur !<br/>Merci de regarder au bas de cette fenêtre.<div><input id=\"pma_ignore_errors_popup\" type=\"submit\" value=\"Ignorer\" class=\"floatright\" style=\"margin-top: 20px;\"><input id=\"pma_ignore_all_errors_popup\" type=\"submit\" value=\"Ignorer tout\" class=\"floatright\" style=\"margin-top: 20px;\"></div></div>";
PMA_messages['phpErrorsBeingSubmitted'] = "<div class=\"error\">Des erreurs ont été détectées sur le serveur !<br/>Selon les paramètres, ils sont actuellement soumis, merci de patienter.<br/><img src=\"./themes/original/img/ajax_clock_small.gif\" width=\"16\" height=\"16\" alt=\"ajax clock\"/></div>";
